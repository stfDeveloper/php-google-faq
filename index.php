...
$faq = [
    ...
    [
     ...
     <ul>1.La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto
      delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle
       ...
       <li>a. Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.
       </li> <li>b.Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li> </ul> <ul>2.La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</ul> Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account."
    ],
...
<body>
    <header>
        ...
        <div class="container d-flex">
            <div class="section">Introduzione</div>
            <div class="section">Norme sulla privacy</div>
            <div class="section">Termini di servizio</div>
            <div class="section">Tecnologie</div>
            <div class="section active">Domande Frequenti</div>
        </div>
    </header>
    <hr>
    <main>
